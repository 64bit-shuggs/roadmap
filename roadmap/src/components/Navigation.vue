...
<header class="z-30 w-full px-2 py-4 bg-white sm:px-4">
  <div class="flex items-center justify-between mx-auto max-w-7xl">
    <a href="/home" title="Home Page" class="flex items-center">
    ...
    <div class="flex items-center space-x-1">
      ...
      <!-- <RouterLink to="/contact" class="btn btn-sm btn-primary">Contact Me!</RouterLink> -->
      <div class="inline-flex md:hidden" x-data="{ open: false }">
        ...
        <div class="absolute top-0 left-0 right-0 z-50 flex flex-col p-2 pb-4 m-2 space-y-3 bg-white rounded shadow" x-show.transition="open" x-on:click.away="open = false" x-cloak>
          ...
          <RouterLink to="/contact" class="w-full btn btn-link">Contact Me!</RouterLink>
        </div>
      </div>
    </div>
  </div>
